\cventry
{\entryshortmonth{18}{5} -- \entryshortmonth{18}{8}}
{\bilingual{Finance Dept.\ Intern}{财务部实习生}}
...
{%
    \begin{itemize}
       ...
       % \item
        ...
        \item
            \bilingual{%
                Resolved discrepancies, prepared for audits and worked directly with auditors to facilitate process
            }{%
            \missing
            }
        \item
            \bilingual{%
                Check work papers, including bank reconciliations, depreciation schedules, contracts and amortization schedules, prepaid and accrued expenses, aging of receivables and payables, stock holders' equity accounts
            }{%
            \missing
            }
    \end{itemize}

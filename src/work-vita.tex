\cventry
{\entryshortmonth{2019}{1} -- \entryshortmonth{2019}{4}}
{\bilingual{IRS Volunteer Income Tax Assistant}{税务助理}}
...
{%
    \begin{itemize}
        ...
        \item
            \bilingual{%
                Consolidated and validated data for taxpayers' results to improve the accuracy of information with details
